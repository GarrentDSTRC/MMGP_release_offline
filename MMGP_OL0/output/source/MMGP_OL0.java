...
public class MMGP_OL0 extends PApplet {
...
public void draw() {
  ...
  while(flagGP==1){
    ...
    theta0 = PApplet.parseFloat(pieces1[2]);Phi = PApplet.parseFloat(pieces1[3]);nacaName1 = PApplet.parseFloat(pieces1[4]);nacaName2 = PApplet.parseFloat(pieces1[5]);nacaName3 = PApplet.parseFloat(pieces1[6]);  Re = PApplet.parseInt(pieces1[7]); // 添加新的雷诺数参数 <-- New change here
...
class generateNaca extends Body{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "MMGP_OL0" };
    if (passedArgs != null) {
